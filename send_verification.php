...
function sendemail_verify($name, $email, $verify_token) {
    ...
    $mail->Password   = 'bvvmpoeglluldhwj'; // Replace with your Gmail app password
    $mail->SMTPSecure = 'tls';
    $mail->Port       = 465;
    ...
    $mail->Body    = 'Please click on the following link to verify your email address: <a href="http://localhost/betpro/forget-pass.php?token=' . $verify_token . '">Verify Email</a>';
...
if (isset($_POST['register'])) {
    ...
    mysqli_stmt_bind_param($stmt_insert_user, 'ssss', $name, $email, $hashed_password, $verify_token);
